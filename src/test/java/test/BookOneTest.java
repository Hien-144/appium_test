...
public class BookOneTest {
			...
			if (i < 2) { // roomroom
				...
				if (!bookPeopleOnes.get(i).getExpectDisable()) {
					try {
						...
						AssertJUnit.assertFalse(btnSub.isEnabled());
					...
					try {
						...
						AssertJUnit.assertTrue(bookPeopleOnes.get(i).getExpect().contains(actual));
						ft.write(i + 22, 7, "Pass");
					} catch (AssertionFailedError e) {
						// TODO: handle exception
						ft.write(i + 22, 7, "Faild");
    ...
    public void testReset() throws InterruptedException {
		...
		try {
			...
			AssertJUnit.assertTrue(actual.equalsIgnoreCase(broreset.getExpect()));
			ft.write(29, 7, "Pass");
		} catch (AssertionFailedError e) {
			// TODO: handle exception
			ft.write(29, 7, "Faild");
